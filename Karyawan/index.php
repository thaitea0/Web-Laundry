...
if($_SESSION == null){ //jika session null atau kosong harus login terlebih dahulu
	...
	echo "<script>location='login.php';</sript>";
}
include 'koneksi.php';
?>
<!DOCTYPE html>
...
<head>
  ...
  <title>Karyawan AFK-Laundry</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="index.php?page=dashboard">Arfika Laundry</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
          <a class="nav-link" href="index.php?page=listorder">
            <i class="fa fa-fw fa-table"></i>
            <span class="nav-link-text">Order Jemputan</span>
          </a>
        </li>
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
