   ...
   <body>
   	<div class="sidenav">
         <div class="login-main-text">
            <h2>ARFIKA LAUNDRY OWNER DAN KARYAWAN</h2>
   ...
   if(isset($_POST['login'])){ //jika ada post masuk yg bernama login atau data yg masuk dari form yang kita isi
   	...
   	if(mysqli_num_rows($query) == 0){//jika data yg diinputkan tidak ada atau 0 maka akan terjadi error
   		...
   		//if(password_verify($password, $data['password'])){
              ...
              echo "<script>alert('Anda Berhasil Login Sebagai Karyawan')</script>";
   						echo "<meta http-equiv='refresh' content='1;url=karyawan/index.php'>";
          ...
          echo "<script>swal('Login Berhasil', 'Selamat Datang $username');</script>";
              ...
              echo "<script>alert('Anda Berhasil Login Sebagai owner')</script>";
              echo "<meta http-equiv='refresh' content='1;url=owner/index.php'>";
   		
   			}else{
   				echo "<script>alert('Login Gagal, Cek ulang username dan password yang anda masukkan')</script>";
